...
const Login = () => {
  ...
  const mockCredentials = {
    ...
    worker: { phone: '0987654321', otp: '123456', role: 'worker' },
  };
  ...
  const handlePhoneSubmit = (e) => {
    ...
    if (!isValidCredential) {
      setError(`Invalid phone number. Use ${mockCredentials?.store?.phone} (Store) or ${mockCredentials?.worker?.phone} (Worker)`);
      return;
    }
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
      ...
      <div className="hidden lg:flex flex-col items-center">
        ...
        <div className="mt-8 space-y-4 text-left max-w-md">
          ...
          <div className="flex items-center gap-3">
            <Icon name="CheckCircle" size={20} className="text-primary" />
            <span className="text-foreground">Trusted by freelancers</span>
          </div>
        </div>
      </div>
